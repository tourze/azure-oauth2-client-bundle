...
class AttributeControllerLoader extends Loader implements RoutingAutoLoaderInterface
{
    ...
    public function __construct()
    {
        ...
        $this->collection->addCollection($this->controllerLoader->load(AzureOAuth2CallbackController::class));
        $this->collection->addCollection($this->controllerLoader->load(AzureOAuth2LoginController::class));
    }
