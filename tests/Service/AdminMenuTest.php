...
use Tourze\AzureOAuth2ClientBundle\Service\AdminMenu;
...
final class AdminMenuTest extends AbstractEasyAdminMenuTestCase
{
    ...
    public function testInvokeMethod(): void
    {
        ...
        try {
            ...
            TestCase::fail('AdminMenu __invoke method should not throw exception: ' . $e->getMessage());
        }
    }
    ...
    protected function onSetUp(): void
    {
        ...
        $this->item->method('getChild')->willReturnCallback(function ($name) use ($childItem) {
            return 'Azure OAuth2' === $name ? $childItem : null;
        });
